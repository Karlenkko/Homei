...
Component({
  ...
  lifetimes: {
    attached: function() {
      ...
      let src = []
      this.setData({
        rating1: this.properties.rating
      })
      if (temp >= 0.5 && temp < 1){
      ...
      this.setData({
        img1: src[0]?src[0]:'images/empty_star.png',
        img2: src[1]?src[1]:'images/empty_star.png',
        img3: src[2]?src[2]:'images/empty_star.png',
        img4: src[3]?src[3]:'images/empty_star.png',
        img5: src[4]?src[4]:'images/empty_star.png'
      })
    },
  },
  observers:{
